...
when isMainModule:
  ...
  echo("Day 1_2: ", day1_2("./problem_input/day1/day1input.txt"))

  echo("Day 2: ", day2("./problem_input/day2/day2input.txt"))
  echo("Day 2_2: ", day2_2("./problem_input/day2/day2input.txt"))

  echo("Day 3: ", day3("./problem_input/day3/day3input.txt"))
  echo("Day 3_2: ", day3_2("./problem_input/day3/day3input.txt"))

  echo("Day 4: ", day4("./problem_input/day4/input.txt"))
